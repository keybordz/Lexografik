...
let AI = VowelBlend(first: .A, second: .I, third: nil,
                    ...
                    followerTable: [
                        ...
                        "J":[.L],                 // JAIL
                        "K":[.S],                 // KAISER
                        "L":[.C, .D, .N, .R, .T], // LAIC, LAID, LAIN, LAIR, LAITY
...
let AU = VowelBlend(first: .A, second: .U, third: nil,
                    initCons: [.C, .D, .G, .N, .R, .S, .T, .X],  // AUCTION, AUDIO, AUGUR, AUNT, AURAL, AUSTRIAN, AUTO, AUXILIARY
...
let EA = VowelBlend(first: .E, second: .A, third: nil,
                    ...
                    followerTable: [
                        ...
                        "M":[.D, .L, .N, .S, .T],                           // MEAD, MEAL, MEAN, MEASLES/LY, MEAT
                    ...
                    dynFollowers: { (syll: SyllabicArray, nRemain: Int) -> [Letter] in
                        ...
                        if syll.matchesString("B", matchFull: false) {
                            return [.U]
                        }
                        else {
                            return []
...
let EE = VowelBlend(first: .E, second: .E, third: nil,
                    ...
                    followerTable: [
                        ...
                        "BL":[.D, .P],                      // BLEED, BLEEP,
                        "BR":[.D, .Z],                      // BREED, BREEZE
                        "CH":[.K, .P, .R, .S, .T],          // CHEEK, CHEEP, CHEER, CHEESE, CHEETAH
...
let IE = VowelBlend(first: .I, second: .E, third: nil,
                    ...
                    followerTable: [
                        ...
                        "F":[.F, .L, .R, .N, .S],   // FIEFDOM, FIELD, FIERY, FIEND, FIES(TA)
                        "FL":[.R, .S],              // FLIER, FLIES
                    ...
                    dynFollowers: { (syll: SyllabicArray, nRemain: Int) -> [Letter] in
                        ...
                        else if syll.matchesString("L", matchFull: true) {
                            followers += [.U]
                        }
...
let OA = VowelBlend(first: .O, second: .A, third: nil,
                    ...
                    followerTable: [
                        ...
                        "BL":[.T],                      // BLOAT
                        "BR":[.C, .D],                  // BROACH, BROAD
                        "C":[.C, .G, .L, .S, .T, .X],   // COACH, COAGULANT, COAL, COAST, COAT, COAX
                        "CL":[.K],                      // CLOAK
                        "CR":[.K],                      // CROAK
                        "F":[.L, .M],                   // FOAL, FOAM
                        "FL":[.T],                      // FLOAT
...
let OI = VowelBlend(first: .O, second: .I, third: nil,
                    ...
                    followerTable: [
                        ...
                        "BR":[.D, .L],          // (EM)BROIDERY, BROIL
                        "C":[.F, .L, .N, .T],   // COIFFURE, COIL, COIN, COITUS
                        "CH":[.C, .R],          // CHOICE, CHOIR
                        "CL":[.S],              // CLOISTER
                        "D":[.L, .N],           // DOILY, DOING
                        "F":[.L, .S],           // FOIL, FOIST
                        "G":[.L, .N, .T],       // GOIL, GOING, GOITER
                        "GR":[.N],              // GROIN
                        "H":[.S],               // HOIST
                        "J":[.N, .S],           // JOIN(T), JOIST
                        "L":[.N, .T],           // LOIN, LOITER
...
let OO = VowelBlend(first: .O, second: .O, third: nil,
                    ...
                    followerTable: [
                        ...
                        "SN":[.D, .K, .P, .T, .Z],              // SNOOD, SNOOKER, SNOOP, SNOOT, SNOOZE
...
let OU = VowelBlend(first: .O, second: .U, third: nil,
                    ...
                    glottal: false,
                    followerTable: [
                        "B":[.D, .F, .G, .L, .N, .Q, .T], // BOUDOIR, BOUFFANT, BOUGHT, BOULDER, BOUNCE/BOUND/BOUNTY, BOUQUET, BOUT
                        "BL":[.N, .S],                  // BLOUNT, BLOUSE
                        "BR":[.G],                      // BROUGHT
                        "C":[.C, .L, .N, .P, .R, .T],   // COUCH, COULE/COULD, COUNT, COUP(E), COURAGE/COURSE/COURT, COUTURE
                        "CL":[.D, .T],                  // CLOUD, CLOUT
                        "CR":[.C, .T],                  // CROUCH, CROUTON
                        "D":[.B, .G, .R, .S],           // DOUBT, DOUGH, DOUR, DOUSE
                        "DR":[.G],                      // DROUGHT
                        "F":[.G, .L, .N, .R],           // FOUGHT, FOUL, FOUND/FOUNT, FOUR(TH)
                        "FL":[.N, .R, .T],              // FLOUNCE/FLOUNDER, FLOUR, FLOUT
                        "G":[.G, .R, .T],               // GOUGE, GOURD, GOUT
                        "GH":[.L],                      // GHOUL
                        "GR":[.C, .N, .P, .S, .T],      // GROUCH, GROUND, GROUP, GROUSE, GROUT
                        "H":[.N, .R, .S],               // HOUND, HOUR, HOUSE
                        "J":[.L, .R, .S],               // JOULE, JOURNEY, JOUST
                        "L":[.D, .R, .S, .T],           // LOUD, LOUR, LOUSE, LOUT
                        "M":[.N, .R, .S, .T],           // MOUND/T, MOURN, MOUSE, MOUTH
                        "N":[.G, .N],                   // NOUGHT, NOUN
                        ...
                        "SPR":[.T],                     // SPROUT
                        "ST":[.T],                      // STOUT
                        "T":[.C, .G, .P, .R, .T],       // TOUCH, TOUGH, TOUPEE, TOUR, TOUT
                        "TH":[.G],                      // THOUGHT
...
let UU = VowelBlend(first: .U, second: .U, third: nil,
                    ...
                    dynFollowers: { (syll: SyllabicArray, nRemain: Int) -> [Letter] in
                        ...
                        // Allow M follower after UU for VACUUM
