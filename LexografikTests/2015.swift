...
//        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "GENUFLECT")))
    ...
    func test_2015Apr10_vectorinG() {
        storm = WordStorm(outer: ["V", "E", "C", "T", "O", "R", "I", "N"], center: "G")
        
        storm.gatherWords(4)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "GIVE")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "GONE")))
        
        storm.gatherWords(5)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "VIGOR")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "GROVE")))
        
        storm.gatherWords(6)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "IGNORE")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "CORING")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "GOVERN")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "REGION")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "CRINGE")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "VOTING")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "ROVING")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "TOEING")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "COGENT")))
        
        storm.gatherWords(8)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "COVETING")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "COVERING")))
        
        storm.gatherWords(9)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "VECTORING")))
    }

    func test_2015Apr14_aDdressee() {
        storm = WordStorm(outer: ["A", "D", "R", "E", "S", "S", "E", "E"], center: "D")
        
        storm.gatherWords(4)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "READ")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SEED")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DARE")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DEAR")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "REDS")))
        
        storm.gatherWords(5)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "READS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DRESS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SEEDS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DARES")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DARED")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DEERS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DREAD")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DEEDS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "REEDS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DEARS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "ADDER")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "EASED")))
        
        storm.gatherWords(6)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DREADS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SADDER")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SEARED")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SEEDED")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "ADDERS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SEEDER")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "RESEED")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DEADER")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "ERASED")))
        
        storm.gatherWords(7)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "ADDRESS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DRESSED")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "RESEEDS")))
        
        storm.gatherWords(9)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "ADDRESSEE")))
    }

    func test_2015May06_pulMonary() {
        storm = WordStorm(outer: ["P", "U", "L", "O", "N", "A", "R", "Y"], center: "M")
        
        storm.gatherWords(4)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PRAM")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PLUM")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "LUMP")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PUMA")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "RAMP")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "MAUL")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "RUMP")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "ALUM")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PROM")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "MUON")))

        storm.gatherWords(5)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "MOURN")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "AMPLY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "LUMPY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "LOAMY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "MURAL")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PALMY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PLUMY")))

        storm.gatherWords(6)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "NORMAL")))

        storm.gatherWords(9)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PULMONARY")))
    }

    func test_2015May28_backwaRds() {
        storm = WordStorm(outer: ["B", "A", "C", "K", "W", "A", "D", "S"], center: "R")
        
        storm.gatherWords(4)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DRAW")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "CARD")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "WARD")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BRAD")))
        
        storm.gatherWords(5)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DRAWS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "AWARD")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "WARDS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "CRAWS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SWARD")))
        
        storm.gatherWords(6)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "AWARDS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "WRACKS")))
        
        storm.filterStops = false     // BACKWARD
        storm.gatherWords(8)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BACKWARD")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DRAWBACK")))
    }
    ...
    func test_2015Apr23_severallY() {
        ...
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "VERY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "RAYS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "LEVY")))

        storm.gatherWords(5)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "YEARS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SLYER")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "LEERY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "YELLS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "LYRES")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SAYER")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SALLY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "EVERY")))

        storm.gatherWords(6)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "REALLY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "RELAYS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "VALLEY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "LAYERS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "ALLEYS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SLAYER")))

        storm.gatherWords(7)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "VALLEYS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SLAVERY")))
    }

    func test_2015May14_Boyfriend() {
        storm = WordStorm(outer: ["O", "Y", "F", "R", "I", "E", "N", "D"], center: "B")
        
        storm.gatherWords(4)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BIRD")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BEND")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BIND")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BODY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BOND")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BONY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BIDE")))

        storm.gatherWords(5)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BORNE")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BRIDE")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "ROBIN")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BONED")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "EBONY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BRINY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DERBY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BONEY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BONER")))

        storm.gatherWords(6)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BINDER")))
        
        storm.gatherWords(9)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BOYFRIEND")))
    }

    func test_2015Jun08_judgeShip() {
        storm = WordStorm(outer: ["J", "U", "D", "G", "E", "H", "I", "P"], center: "S")
        
        storm.gatherWords(4)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PUDS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DIGS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PUSH")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SHED")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SPED")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "HUGS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "JUGS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "JIGS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "GUSH")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SIGH")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SPUD")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PEGS")))

        storm.gatherWords(5)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "HIDES")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "DUPES")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SHIED")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "GUISE")))
        
        storm.gatherWords(6)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "JUDGES")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PUSHED")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "GUSHED")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SIGHED")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "UPSIDE")))

        storm.gatherWords(9)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "JUDGESHIP")))
    }

    func test_2015Jun04_exchAnges() {
        storm = WordStorm(outer: ["E", "X", "C", "H", "N", "G", "E", "S"], center: "A")
        
        storm.gatherWords(4)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "AXES")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SCAG")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "GASH")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "HANG")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "HAGS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SHAG")))

        storm.gatherWords(5)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "ACHES")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "GNASH")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "CAGES")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "HANGS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "CEASE")))
        
        storm.gatherWords(7)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "CHANGES")))

        storm.filterStops = false
        storm.gatherWords(8)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "EXCHANGE")))
    }

    func test_2015Aug10_Hermitage() {
        storm = WordStorm(outer: ["E", "R", "M", "I", "T", "A", "G", "E"], center: "H")
        
        storm.gatherWords(4)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "THEM")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "HAME")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "HIRE")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "AHEM")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "HEIR")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "HERE")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "MATH")))
        
        storm.gatherWords(5)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "THREE")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "THERE")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "RIGHT")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "MIGHT")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "EARTH")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "THEIR")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "ETHER")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "THEME")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "GIRTH")))

        storm.gatherWords(6)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "HERMIT")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "HEATER")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "GATHER")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "REHEAT")))

        storm.gatherWords(8)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "HERITAGE")))
        
        storm.gatherWords(9)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "HERMITAGE")))
    }

    func test_2015Aug10_blasphemY() {
        storm = WordStorm(outer: ["B", "L", "A", "S", "P", "H", "E", "M"], center: "Y")
        
        storm.gatherWords(4)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PAYS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "YAPS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "YAMS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BAYS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SPAY")))
        
        storm.gatherWords(5)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PHYLA")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "LYMPH")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PLAYS")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SPLAY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BALMY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SYLPH")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "PALSY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SEAMY")))
        
        storm.gatherWords(6)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "MEASLY")))
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BELAYS")))
        
        storm.gatherWords(7)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "SHAPELY")))
        
        storm.gatherWords(9)
        XCTAssertTrue(storm.allWords.contains(LetterArray(initString: "BLASPHEMY")))
    }
}
